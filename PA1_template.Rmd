...
The mean number of steps per day is `r round(mean.stpsdy, 2)` and the median
number of steps per day is `r round(median.stpsdy, 2)`.
...
Interval `r interval` contains the maximum number of steps, on average.
...
The total number of missing values within the dataset is `r sum.na`.
...
The mean number of steps per day is `r round(mean.stpsdy2, 2)` and the median
number of steps per day is `r round(median.stpsdy2, 2)`.
